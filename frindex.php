...
<html lang="fr">
  <head>
    ...
    <title>Conception Web Socialement Radical</title>
  </head>
  <body>
    <header>
      <div class="container">
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="parent_navigation nav-item"><a class="navigation nav-link active" aria-current="page" href="#index"><button type="button" class="btn btn-outline-dark">Accueil</button></a></li>
                ...
                <li class="parent_navigation nav-item"><a class="navigation nav-link active" aria-current="page" href="#"><button type="button" class="btn btn-outline-dark"><img src="Images/united-kingdom.png" width="20px" height="20px">Anglais</button></a></li>
                <li class="parent_navigation nav-item"><a class="navigation nav-link disabled" aria-current="page" href="frindex.png"><button type="button" class="btn btn-outline-dark"><img src="Images/france.png" width="20px" height="20px">Français</button></a></li>
              </ul>
            </div>
          </div>
        </nav>
