...
<html lang="fr">
  ...
  <body>
    ...
    <main>
      ...
      <div class="container bg-success bg-gradient bg-opacity-50 rounded-3 border border-dark border-5">
                    ...
                    <div id="carouselCaptions" class="carousel slide" data-bs-ride="carousel">
                      ...
                      <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                          ...
                          <div class="carousel-caption d-none d-md-block bg-dark bg-opacity-75">
                            <h5>Consultation du Site Web pour Féstival de Flamenco</h5>
        ...
        <div class="container bg-success bg-gradient bg-opacity-50 rounded-3 border border-dark border-5">
          <div id="request">
            ...
            <span class="text-danger">**Ceux qui souhaitent contacter Socially Radical Web Design par téléphone, veuillez utiliser Telegram，WhatsApp, ou appelez directement le +852 6604 0514.**</span><br><br>
            <form>
      ...
      <div style="text-align: center;">
        <div style="margin-bottom: 1.25rem;">
          <p>Application d'une seule page qui resemble a une site des plusieurs pages. Par example: <a href="https://radesrestaurant.ca" target="_blank">Rade's Restaurant</a></p>
    ...
    var orderDescription = 'Site d\'une seule page qui resemble a une site des plusieurs pages.';
    if(orderDescription === '') {
    ...
    paypal.Buttons({
      ...
      onApprove: function(data, actions) {
        return actions.order.capture().then(function(orderData) {
          ...
          element.innerHTML = '';
          element.innerHTML = '<h3>Merci de votre achat!</h3>';
  ...
  initPayPalButton();
    ...
    <footer>
      ...
      <p class="text-center"><a href="https://www.flaticon.com/free-icons/flag" target="_blank" title="flag icons">Icônes de drapeau créées par Freepik - Flaticon</a></p>
    </footer>
