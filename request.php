    ...
    <main>
      ...
      <div class="container">
        <?php
          ...
          if($input) {
          echo "<p>Thank you for making the request! Socially Radical Web Design will contact you within 24-48 hours about your order. To return to the main page, click <a href='index.php'>here</a>.</p>";
          }
          else {
              echo "<p>500. Internal error. Our apologies. Please try again later.</p>";
          }
        ?>
      </div>
    </main>
